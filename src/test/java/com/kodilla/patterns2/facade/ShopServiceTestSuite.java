...
public class ShopServiceTestSuite {
    ...
    public void testShopFacade() {
        ...
        order.addItem(new ItemDto(10L, 2.0));
        order.addItem(new ItemDto(216L, 1.0));
        order.addItem(new ItemDto(25L, 1.0));
        order.addItem(new ItemDto(11L, 3.0));
        try {
